...
<?php 
    $id =$_GET['id'];
    $sql1 = "SELECT * FROM khachhang, sanpham where khachhang.MaK='$id' ";
...
<body>
    ...
    <section>
        ...
        <div class="mt-2" style="background:#f1f1f1">
            <div class="container">
                <p class="px-5 ms-2 py-2 text-muted mb-0" style="font-size:13px">Trang chủ / Hướng dẫn mua hàng tại Web CSE481</p>
            </div>
        </div>
    </section>
    <section class="pb-5" style="">
        <div class="container">
            <div class="px-5">
                ...
                <p class="link-danger mt-5 fw-bold fs-3">Hướng dẫn mua hàng tại Web CSE481</p>
                <p class="fw-bold">1. Hướng dẫn sử dụng website.</p>
                <p>- Các bước mua hàng tại web.</p>
                <p>+ Chọn sản phẩm bạn muốn mua -> Chọn size và số lượng mong muốn -> Thêm vào giỏ hàng -> Xem giỏ hàng để thanh toán.</p>
                <p>(Trong trường hợp bạn muốn thay đổi thông tin sản phẩm muốn mua, bạn vào giỏ hàng để thay đổi thông tin)</p>
            </div>
        </div>
    </section>
