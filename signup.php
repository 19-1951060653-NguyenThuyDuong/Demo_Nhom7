...
<body style="font-family:'Arial'">
    <div class="mx-auto text-center">
        <p style="font-size:50px;color:#f7b400;font-family:'Arial'" class="mb-0 fw-bolder">NHOM7</p>
    </div>
            ...
            <div class="mt-2 ms-3 row">
                <div class="login col-md-12 d-flex justify-content-center">
                    <div style="box-shadow: 0 2px 4px 0 #0000001a, 0 8px 16px 0 #0000001a;background:white;width:500px;border-radius:8px"
                        class="">
                        <p class="ps-4 mt-3 fs-2 mb-0 fw-bold ">Đăng ký</p>
                        <p class="ps-4 text-muted">Nhanh chóng và dễ dàng</p>
                        <hr>
                            ...
                            <div class="pt-1 pb-3 mx-3">
                                ...
                                <div class="mx-auto p-1  text-center">
                                    <button style="color:white;background:#42b72a"
                                        ...
                                        name="btnSignup">Đăng ký</button>
                                </div>
                            </div>
                        </form>
                        <a class="text-decoration-none link-dark" style="font-size:13px"href="index.php">
                        <div class="mb-3 ms-1">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <p class="ms-2 d-inline">Quay lại trang chủ</p>
                        </div>
                        </a>
                    </div>
                </div>
