...
<?php 
    $id =$_GET['id'];
    $id1 =$_GET['id1'];
    $sql = "SELECT *,sanpham.Giaban-(sanpham.Giaban*sanpham.Tylegiamgia) as Giagiam FROM khachhang,sanpham where khachhang.MaK='$id1' and sanpham.MaSP = '$id'";
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 mt-3">
                    <form class="add-item-form"  method="post" action="cart/cart_add.php?id=<?php echo $id1?>&id1=<?php echo $id?>">
                    ...
                    <hr>
                    <h4 class="text-warning" name="giaban"><?php echo number_format($row['Giagiam']); ?> VNĐ</h4>
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <div class="mt-3">
                            ...
                            name="txtMota"required><?php echo $row['Mota'];?></textarea>
